...
func TestRunner_ListPending_NonePending(t *testing.T) {
	...
	if pending != nil {
		t.Errorf("expected nil pending, got %d entries", len(pending))
	}
	if err := mock.ExpectationsWereMet(); err != nil {
		t.Errorf("unmet expectations: %v", err)
	}
...
func TestRunner_PendingCount_Some(t *testing.T) {
	...
	// 000001 is already applied, no migrations pending
	if count != 0 {
...
func TestRunner_DryRun_NonePending(t *testing.T) {
	...
	if names != nil {
		t.Errorf("expected nil, got %d entries", len(names))
	}
	if err := mock.ExpectationsWereMet(); err != nil {
		t.Errorf("unmet expectations: %v", err)
	}
...
func TestRunner_UnappliedSince_HasUnapplied(t *testing.T) {
	...
	if results != nil {
		t.Errorf("expected nil (all applied), got %d results", len(results))
	}
	if err := mock.ExpectationsWereMet(); err != nil {
		t.Errorf("unmet expectations: %v", err)
	}
...
func TestRunner_PendingCount_NoMigrations(t *testing.T) {
	...
	// DirectionDown has only 1 file (000001_foundation.down.sql).
